...
-- 业务字段
INSERT INTO `ymwl_system_field` (`name`, `xsname`, `field`, `type`, `rule`, `msg`, `lang`, `is_null`, `create_time`, `update_time`, `formtype`, `table`, `list`, `list_sort`, `form`, `search`, `total`, `export`, `sort`, `option`, `join_table`, `default`, `foreign_key`, `describe`, `href`, `relationship_primary_key`, `grid`, `is_key`, `width`, `jscol`, `addinput`, `editinput`) VALUES
