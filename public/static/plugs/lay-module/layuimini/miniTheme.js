        ...
        config: function (bgcolorId) {
            var bgColorConfig = [
                ...
                },
                {
                    ...
                    headerRightNavMoreBg: '#18bc9c', //头部右侧更多下拉列表选中背景色,
                    headerRightNavMoreColor: '#ffffff', //头部右侧更多下拉列表字体色,
                ...
                },
                {
                    ...
                    leftMenuNavMore: 'rgb(191, 187, 187)', //左侧菜单更多下拉样式,
                    leftMenuBg: '#23262e', //左侧菜单背景,
                    leftMenuBgThis: '#18bc9c', //左侧菜单选中背景,
                    leftMenuChildBg: 'rgba(0,0,0,.3)', //左侧菜单子菜单背景,
                    leftMenuColor: 'rgb(191, 187, 187)', //左侧菜单字体颜色,
                    leftMenuColorThis: '#ffffff', //左侧菜单选中字体颜色,
                    tabActiveColor: '#18bc9c', //tab选项卡选中颜色,
                },
                {
        ...
        listen: function (options) {
            $('body').on('click', '[data-bgcolor]', function () {
                ...
                var html = '<div class="layuimini-color">\n' +
                    ...
                    '<span>'+fy('Color scheme')+'</span>\n' +
                    '</div>\n' +
                    '<div class="color-content">\n' +
                    '<ul>\n' + bgColorHtml + '</ul>\n' +
                    '</div>\n' +
                    '<div class="more-menu-list">\n' +
                    '<a class="more-menu-item" href="http://www.80zx.com/" target="_blank"><i class="layui-icon layui-icon-read" style="font-size: 19px;"></i>' +fy('Technical blog')+'</a>\n' +
                    '</div>' +
                    '</div>';
                layer.open({
                    type: 1,
