...
layui.define('jquery', function (exports) {
    ...
    var SelectPage = function (input, option) {
        //特殊字段处理
        $.each({data: 'source', keyField: 'primaryKey', showField: 'field', pageSize: 'perPage',searchKey:'searchKey'}, function (i, j) {
        ...
        switch (p.lang) {
            ...
            case 'en':
                message = {
                    ...
                    max_selected: 'You can only select up to max_selected_limit'
                };
                break;
            // 中文
            case 'cn':
            default:
                message = {
                    ...
                    clear_all: '清除全部已选择项目',
                    max_selected: '最多只能选择 max_selected_limit 个'
                };
                break;
        }
    ...
    function Plugin(option) {
        return this.each(function () {
            var $this = $(this),
                ...
                params = $.extend({}, defaults, data && data.option, typeof option === 'object' && option,$this.data());
