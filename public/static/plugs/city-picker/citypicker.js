...
layui.define(['jquery'], function (exports) {
    ...
    CityPicker.prototype = {
        ...
        getPlaceHolder: function () {
            return this.$element.data('placeholder') || this.options.placeholder;
        },
