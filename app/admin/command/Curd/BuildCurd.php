...
namespace app\admin\command\Curd;

use app\admin\command\curd\exceptions\TableException;
...
class BuildCurd
{
    ...
    public function setTable($table)
    {
        ...
        try {
            ...
            // 获取表名注释
            $tableSchema = Db::query("SELECT table_name,table_comment FROM information_schema.TABLES WHERE table_schema = '{$this->dbName}' AND table_name = '{$this->tablePrefix}{$this->table}'");
